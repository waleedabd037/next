...
const demoCategories = [
    ...
    { id: "ss6412b4-22fd-4fbb-9741-d77512dfdfa3", name: "computers" },
    { id: "fs6412b4-22fd-4fbb-9741-d77512dfdfa3", name: "printers" },
];

async function insertDemoData() {
    try {
        // Insert or update demo categories
        for (let category of demoCategories) {
        ...
        // Insert or update demo products
        ...
        const admin = await prisma.admin.upsert({
            where: { email: "waleed.abdullah@autogen.com" },
            update: {},
            create: {
                id: "2025",
                email: "waleed.abdullah@autogen.com",
                password: hashedPassword,
                role: "admin",
            },
        });
        console.log("Demo admin inserted/updated successfully!");
