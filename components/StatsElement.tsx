...
const StatsElement = () => {
  return (
    <div className="w-80 h-32 bg-gradient-to-b from-gray-800 via-gray-900 to-black text-white flex flex-col justify-center items-center rounded-md max-md:w-full">
